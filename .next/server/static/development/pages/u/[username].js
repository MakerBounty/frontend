...
/* harmony default export */ __webpack_exports__["default"] = ({
  isomorphic: async (method, endpoint, ctx) => {
    try {
      ...
      const res = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_2___default()(LOCAL_API_URL + endpoint);
  ...
  swr: async (method, endpoint, authToken) => {
    try {
      ...
      if (authToken) options.headers["Authentication"] = `Bearer ${authToken}`;
      const res = await unfetch__WEBPACK_IMPORTED_MODULE_1___default()(API_URL + endpoint);
    } catch (e) {
      console.error(e);
      return e;
    }
...
const userPage = ({
  ...
  const {
    ...
    bio,
    createdTs
  } = JSON.parse(user.text); // render username
  ...
  bio ? __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("h3", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
    },
    __self: undefined
  }, "Bio:"), __jsx(react_markdown__WEBPACK_IMPORTED_MODULE_4___default.a, {
    source: bio,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30
...
userPage.getInitialProps = async ctx => {
  try {
    ...
    const user = await _lib_api__WEBPACK_IMPORTED_MODULE_2__["default"].isomorphic("GET", `/api/user/describe/${username}`, ctx);
    return {
      user
    };
  } catch (e) {
...
/***/ 4:
/*!*************************************!*\
  !*** multi ./pages/u/[username].js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/tate/Desktop/makerbounty/frontend/pages/u/[username].js */"./pages/u/[username].js");
